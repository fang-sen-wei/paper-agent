...
- **Chinese Comments**: All new or modified non-obvious code must include **Chinese comments**.
- **Functionality & Intent**: Clearly explain the responsibilities of functions, classes, or core logic, and explain "why" it is written this way rather than just "what" it does.
